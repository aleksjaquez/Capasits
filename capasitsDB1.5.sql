...
CREATE TABLE IF NOT EXISTS `capasits`.`Paciente` (
  ...
  INDEX `fk_Paciente_Antecedentes_idx` (`Antecedentes_id_antecedentes` ASC),
  INDEX `fk_Paciente_Datos1_idx` (`Datos_id_datos` ASC),
  INDEX `fk_Paciente_Antecedentes_21_idx` (`Antecedentes_2_id_antecedentes_2` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Embarazo_ant` (
  ...
  INDEX `fk_Embarazo_ant_Paciente1_idx` (`Paciente_ID_paciente` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Hospitalizacion` (
  ...
  INDEX `fk_Hospitalizacion_Paciente1_idx` (`Paciente_ID_paciente` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Embarazo_act` (
  ...
  INDEX `fk_Embarazo_act_Cita1_idx` (`Cita_id_cita` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Estadificacion` (
  ...
  INDEX `fk_Estadificacion_Cita1_idx` (`Cita_id_cita` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Tratamiento_antiretroviral` (
  ...
  INDEX `fk_Tratamiento_antiretroviral_Cita1_idx` (`Cita_id_cita` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Adherencia` (
  ...
  INDEX `fk_Adherencia_Tratamiento_antiretroviral1_idx` (`Tratamiento_antiretroviral_id_antiretroviral` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Tratamiendo_profilaxis` (
  ...
  INDEX `fk_Tratamiendo_profilaxis_Embarazo_act1_idx` (`Embarazo_act_id_embarazo_act` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Tratamiendo_etapas` (
  ...
  INDEX `fk_Tratamiendo_etapas_Cita1_idx` (`Cita_id_cita` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Tratamiento_antifimico` (
  ...
  INDEX `fk_Tratamiento_antifimico_Cita1_idx` (`Cita_id_cita` ASC),
...
CREATE TABLE IF NOT EXISTS `capasits`.`Usuario_Tipo` (
  ...
  INDEX `fk_Usuario_Tipo_Usuario1_idx` (`Usuario_idAdmin` ASC),
  INDEX `fk_Usuario_Tipo_TipoU1_idx` (`TipoU_idTipoU` ASC),
