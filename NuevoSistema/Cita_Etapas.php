				...
				<div class="row justify-content-start"> 
					...
					<div id="sidebar" class="col-4">
						<section>
							...
							<ul class="nav flex-column nav-pills" flex-sm-column>
								...
								<li class="nav-item col-10">
									<a class="nav-link active bg-dark" href="#">Tratamiento</a>
								</li>
					...
					<div id="content" class="8u skel-cell-important">
						<section>
							...
							<form>
							<h3>Etapa</h3>
							<input type="radio" name="etapa" value="1"> 1 -> 2 meses 
							<input type="radio" name="etapa" value="2"> 2 -> 4 meses				
							<br><br>
							<h3>Fármaco</h3>
							<input type="text" name="farmaco" max="45" placeholder="farmaco" required>
							<br><br>
							<h3>Fecha de inicio </h3>
							<input name="presion_ar" id="presion_ar" type="date" required>
							<br><br>
							<h3>Fecha de término </h3>
							<input name="frecuencia_car" id="frecuencia_car" type="date" required>
							<br><br>								    
