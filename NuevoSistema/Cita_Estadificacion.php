				...
				<div class="row justify-content-start"> 
					...
					<div id="sidebar" class="col-4">
						<section>
							...
							<ul class="nav flex-column nav-pills" flex-sm-column>
								...
								<li class="nav-item col-10">
									<a class="nav-link active bg-dark" href="#">Estadificación</a>
								</li>
					...
					<div id="content" class="8u skel-cell-important">
						<section>
							...
							<form>	
							<h3>Estadio</h3>
							<input type="radio" name="estadio" value="A"> A 
							<input type="radio" name="estadio" value="B"> B 
							<input type="radio" name="estadio" value="C"> C 
							<br><br>
							<h3>Fecha</h3>
							<input class="form-control" type="date" name="fecha_ini" id="fecha" required> 
							<br><br>
							<h3>Tratamiento</h3>
							<input class="form-control" type="text" name="tratamiento" max="99" placeholder="tratamiento" required>
							<br><br>
							<h3>Suspension</h3>
							<input name="suspension" type="radio" value="1" class="yes" data-toggle="collapse" data-target="#collapseOne"/> Si
         					<input name="suspension" type="radio" value="2" class="no" data-toggle="collapse" data-target="#collapseOne" checked/> No       							
							<br><br>
							<pp>
							<h3>Motivo</h3>
							<input class="form-control" type="text" name="motivo" size="50" maxlength="999" value="motivo" >
							<br><br>
							<h3>Terminacion</h3>
							<input class="form-control" type="date" name="fecha_termi" id="fecha" required>
							</pp>
							<br><br>    
							<button class="form-control" type="submit" class="btn btn-dark">Guardar y avanzar</button>
							</form>
					</div>					
				</div>
			</div>
