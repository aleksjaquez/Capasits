...
*/
    ...
    if($Antico=="1"){
            ...
            $queryAntecedentes="INSERT INTO antecedentes(factor,inicio_sex,num_parejas,antico,metodo_antico,fecha_diagnostico,metodo_diagnostico,fecha_pro_inf,fecha_ini_man) VALUES('$Factor','$Sex','$Pareja','$Antico','$MAntico','$FechaD','$MetodoD','$FechaInf','$FechaMan')";
            $link->query($queryAntecedentes);
            
        }else{


            $queryAntecedentes="INSERT INTO antecedentes(factor,inicio_sex,num_parejas,antico,fecha_diagnostico,metodo_diagnostico,fecha_pro_inf,fecha_ini_man) VALUES('$Factor','$Sex','$Pareja','$Antico','$FechaD','$MetodoD','$FechaInf','$FechaMan')";
            $link->query($queryAntecedentes);
